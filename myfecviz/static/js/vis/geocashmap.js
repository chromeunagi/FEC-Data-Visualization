...
USCashMap.prototype.render = function (data) {
    ...
    this.states.on('mouseover', function(d, e, p){
        ...
        console.log("x");
        d3.select(this).transition().duration(5).attr("fill", '#4CAF50');
        console.log("y");
    ...
    this.states.on('mouseout', function(d, e, p){
        ...
        d3.select(this).transition().duration(1).attr("fill", moneyColorScale(d['total_amount']));
    });
    ...
    this.states.on('click', function(d, e, p){
        ...
        that.addStateToSelection(d['state']);
        d3.select(this).transition().duration(1).attr("fill", '#FF9933');
        that.setInspectionInfo(d['state'], d['total_amount']);
